...
public class PlayerTest {
	 ...
	 * testPoprawnosciWyjatkuGdyGraczWymieniaWiecejNiz4Elementow() { someCards =
	 * new ArrayList<>(); someCards.add(new Card(CourtEnum.FOUR,
	 * SuitEnum.HEART)); someCards.add(new Card(CourtEnum.KING,
	 * SuitEnum.SPADE)); someCards.add(new Card(CourtEnum.TWO,
	 * SuitEnum.DIAMOND)); someCards.add(new Card(CourtEnum.TWO,
	 * SuitEnum.CLUB)); someCards.add(new Card(CourtEnum.SIX, SuitEnum.SPADE));
	 * firstPlayer = new Human(someCards, someTable);
	 * 
	 * List<Card> selectedCards = new ArrayList<Card>();
	 * selectedCards.add(someCards.get(1)); selectedCards.add(someCards.get(2));
	 * selectedCards.add(someCards.get(4));
	 * 
	 * firstPlayer.changeCards(selectedCards); }
	 * 
	 * @Test >>>>>>> .r25 public void testPoprawnosciWYmianyKart() { someCards =
	 * new ArrayList<>(); someCards.add(new Card(CourtEnum.FOUR,
	 * SuitEnum.HEART)); someCards.add(new Card(CourtEnum.KING,
	 * SuitEnum.SPADE)); someCards.add(new Card(CourtEnum.TWO,
	 * SuitEnum.DIAMOND)); someCards.add(new Card(CourtEnum.TWO,
